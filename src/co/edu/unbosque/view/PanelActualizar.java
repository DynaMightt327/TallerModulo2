...
public class PanelActualizar extends JPanel {
	...
	public void initComps() {
		...
		ImageIcon imageLogo = new ImageIcon(getClass().getResource("doctor.JPG"));
		JLabel lIcon = new JLabel(imageLogo);
		lIcon.setBounds(450, 20, 320, 350);
		add(lIcon);

		borrar = new JButton("ACTUALIZAR");
		borrar.setBounds(120, 260, 180, 30);
		...
		texto = new JTextArea("Seleccione que desea actualizar e ingrese \nel indice de dicho elemento:");
		...
		opcion = new JComboBox<String>(new String[] { "...", "Administrativo", "Veterinario", "Cliente", "Ave",
				"Mamifero", "Reptil", "Pez", "Juguete", "Medicamento" });
